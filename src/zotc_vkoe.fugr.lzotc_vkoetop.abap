...
*---------------------------------------------------------------------*
FUNCTION-POOL ZOTC_VKOE.                    "MESSAGE-ID ..

* INCLUDE LZOTC_VKOED...                     " Local class definition

Data: gv_flag  type flag,   " Flag Field
      gv_flag2 type flag.   " Flag Field
