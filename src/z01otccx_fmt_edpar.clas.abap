class Z01OTCCX_FMT_EDPAR definition
  public
...
public section.
  ...
  data ADDITION type Z01OTCEXCHANGE_LOG_DATA read-only .
  ...
  data STANDARD type Z01OTCEXCHANGE_FAULT_DATA read-only .
...
CLASS Z01OTCCX_FMT_EDPAR IMPLEMENTATION.
