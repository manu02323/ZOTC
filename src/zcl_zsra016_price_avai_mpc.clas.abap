class ZCL_ZSRA016_PRICE_AVAI_MPC definition
  public
...
public section.
  ...
  types:
     TS_SHIPTO type ZOTC_SHIPTO_VALUE_HELP .
  types:
TT_SHIPTO type standard table of TS_SHIPTO .
  ...
  types:
     TS_CUSTOMER type ZSRA016_S_PA_CUSTOMER .
  types:
TT_CUSTOMER type standard table of TS_CUSTOMER .
  types:
     TS_PRODUCTAVAILABILITY type ZSRA016_S_PA_PRODUCT_AVAIL .
  types:
TT_PRODUCTAVAILABILITY type standard table of TS_PRODUCTAVAILABILITY .
  types:
     TS_PRODUCTATTRIBUTE type ZSRA016_S_PA_PRODUCT_ATTRB .
  types:
TT_PRODUCTATTRIBUTE type standard table of TS_PRODUCTATTRIBUTE .
  types:
     TS_PRODUCT type ZSRA016_S_PA_PRODUCT .
  types:
...
TT_SOLDTO type standard table of TS_SOLDTO .
  ...
  constants GC_PRODUCTATTRIBUTE type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'ProductAttribute' ##NO_TEXT.
  constants GC_PRODUCTAVAILABILITY type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'ProductAvailability' ##NO_TEXT.
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZSRA016_PRICE_AVAI_MPC====CP' ##NO_TEXT.
  ...
  methods DEFINE_CUSTOMER
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_PRODUCTAVAILABILITY
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_PRODUCTATTRIBUTE
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
...
CLASS ZCL_ZSRA016_PRICE_AVAI_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZSRA016_PRICE_AVAIL_SRV' ).

define_shipto( ).
define_customer( ).
define_productavailability( ).
define_productattribute( ).
define_product( ).
define_soldto( ).
define_associations( ).
  endmethod.
...
***********************************************************************************************************************************
 ...
 lo_association = model->create_association(
                            iv_association_name = 'Customer_to_Product' "#EC NOTEXT
                            iv_left_type        = 'Customer' "#EC NOTEXT
                            iv_right_type       = 'Product' "#EC NOTEXT
                            iv_right_card       = 'M' "#EC NOTEXT
                            iv_left_card        = '1'  "#EC NOTEXT
                            iv_def_assoc_set    = abap_false ). "#EC NOTEXT
* Referential constraint for association - Customer_to_Product
lo_ref_constraint = lo_association->create_ref_constraint( ).
lo_ref_constraint->add_property( iv_principal_property = 'Shiptoparty'   iv_dependent_property = 'Shiptoparty' ). "#EC NOTEXT
lo_ref_constraint->add_property( iv_principal_property = 'CustomerID'   iv_dependent_property = 'CustomerID' ). "#EC NOTEXT
lo_ref_constraint->add_property( iv_principal_property = 'DistributionChannel'   iv_dependent_property = 'DistributionChannel' ). "#EC NOTEXT
lo_ref_constraint->add_property( iv_principal_property = 'Division'   iv_dependent_property = 'Division' ). "#EC NOTEXT
lo_ref_constraint->add_property( iv_principal_property = 'SalesOrganization'   iv_dependent_property = 'SalesOrganization' ). "#EC NOTEXT
lo_assoc_set = model->create_association_set( iv_association_set_name  = 'Customer_to_ProductSet'                         "#EC NOTEXT
                                              iv_left_entity_set_name  = 'Customers'              "#EC NOTEXT
                                              iv_right_entity_set_name = 'ProductCollection'             "#EC NOTEXT
                                              iv_association_name      = 'Customer_to_Product' ).                                 "#EC NOTEXT

 lo_association = model->create_association(
                            iv_association_name = 'Product_to_ProductAvailability' "#EC NOTEXT
                            iv_left_type        = 'Product' "#EC NOTEXT
                            iv_right_type       = 'ProductAvailability' "#EC NOTEXT
                            iv_right_card       = 'M' "#EC NOTEXT
                            iv_left_card        = '1'  "#EC NOTEXT
                            iv_def_assoc_set    = abap_false ). "#EC NOTEXT
* Referential constraint for association - Product_to_ProductAvailability
lo_ref_constraint = lo_association->create_ref_constraint( ).
lo_ref_constraint->add_property( iv_principal_property = 'Shiptoparty'   iv_dependent_property = 'Shiptoparty' ). "#EC NOTEXT
lo_ref_constraint->add_property( iv_principal_property = 'CustomerID'   iv_dependent_property = 'CustomerID' ). "#EC NOTEXT
lo_ref_constraint->add_property( iv_principal_property = 'SalesOrganization'   iv_dependent_property = 'SalesOrganization' ). "#EC NOTEXT
...
lo_assoc_set = model->create_association_set( iv_association_set_name  = 'Product_to_ProductAvailabilitySet'                         "#EC NOTEXT
                                              iv_left_entity_set_name  = 'ProductCollection'              "#EC NOTEXT
                                              iv_right_entity_set_name = 'ProductAvailabilityCollection'             "#EC NOTEXT
                                              iv_association_name      = 'Product_to_ProductAvailability' ).                                 "#EC NOTEXT

 lo_association = model->create_association(
                            iv_association_name = 'Product_To_ProductAttribute' "#EC NOTEXT
                            iv_left_type        = 'Product' "#EC NOTEXT
                            iv_right_type       = 'ProductAttribute' "#EC NOTEXT
                            iv_right_card       = 'M' "#EC NOTEXT
                            iv_left_card        = '1'  "#EC NOTEXT
                            iv_def_assoc_set    = abap_false ). "#EC NOTEXT
* Referential constraint for association - Product_To_ProductAttribute
lo_ref_constraint = lo_association->create_ref_constraint( ).
lo_ref_constraint->add_property( iv_principal_property = 'Shiptoparty'   iv_dependent_property = 'Shiptoparty' ). "#EC NOTEXT
lo_ref_constraint->add_property( iv_principal_property = 'SalesOrganization'   iv_dependent_property = 'SalesOrganization' ). "#EC NOTEXT
lo_ref_constraint->add_property( iv_principal_property = 'Division'   iv_dependent_property = 'Division' ). "#EC NOTEXT
...
lo_ref_constraint->add_property( iv_principal_property = 'CustomerID'   iv_dependent_property = 'CustomerID' ). "#EC NOTEXT
lo_ref_constraint->add_property( iv_principal_property = 'ProductID'   iv_dependent_property = 'ProductID' ). "#EC NOTEXT
lo_assoc_set = model->create_association_set( iv_association_set_name  = 'Product_To_ProductAttributeSet'                         "#EC NOTEXT
                                              iv_left_entity_set_name  = 'ProductCollection'              "#EC NOTEXT
                                              iv_right_entity_set_name = 'ProductAttributeCollection'             "#EC NOTEXT
                                              iv_association_name      = 'Product_To_ProductAttribute' ).                                 "#EC NOTEXT
...
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'ProductAttributes' "#EC NOTEXT
                                                              iv_abap_fieldname = 'PRODUCTATTRIBUTES' "#EC NOTEXT
                                                              iv_association_name = 'Product_To_ProductAttribute' ). "#EC NOTEXT
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'ProductAvailabilities' "#EC NOTEXT
                                                              iv_abap_fieldname = 'PRODUCTAVAILABILITIES' "#EC NOTEXT
                                                              iv_association_name = 'Product_to_ProductAvailability' ). "#EC NOTEXT
  endmethod.
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'CityZip' iv_abap_fieldname = 'CITYZIP' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'SalesOrganizationName' iv_abap_fieldname = 'SALESORGANIZATIONNAME' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'DistributionChannelName' iv_abap_fieldname = 'DISTRIBUTIONCHANNELNAME' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'DivisionName' iv_abap_fieldname = 'DIVISIONNAME' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property->set_as_title( iv_keep_in_content = abap_true ).

lo_entity_type->bind_structure( iv_structure_name   = 'ZSRA016_S_PA_CUSTOMER'
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'ProductID' iv_abap_fieldname = 'MATERIAL' ). "#EC NOTEXT
lo_property->set_is_key( ).
lo_property->set_type_edm_string( ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'ProductDesc' iv_abap_fieldname = 'MATL_DESC' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'BaseUOMDesc' iv_abap_fieldname = 'BASE_UOM_DESC' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'MyProductNo' iv_abap_fieldname = 'CUSTOMER_MATERIAL' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'ProductReferenceNo' iv_abap_fieldname = 'OLD_MAT_NO' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'ProductListPrice' iv_abap_fieldname = 'NET_PRICE' ). "#EC NOTEXT
...
lo_property->set_unit_property( 'Currency' ).  "#EC NOTEXT
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
lo_property->set_sortable( abap_false ).
lo_property->set_nullable( abap_true ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'PrdSearch' iv_abap_fieldname = 'PRD_SERACH' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'CustomerID' iv_abap_fieldname = 'CUSTOMER_NO' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZSRA016_S_PA_PRODUCT'
                                iv_bind_conversions = 'X' ). "#EC NOTEXT
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'ProductCollection' ). "#EC NOTEXT
lo_entity_set->set_label_from_text_element( iv_text_element_symbol = '020' iv_text_element_container = gc_incl_name ).  "#EC NOTEXT
...
lo_entity_set->set_filter_required( abap_true ).
  ...
  method DEFINE_PRODUCTATTRIBUTE.
*&---------------------------------------------------------------------*
*&           Generated code for the MODEL PROVIDER BASE CLASS         &*
*&                                                                     &*
*&  !!!NEVER MODIFY THIS CLASS. IN CASE YOU WANT TO CHANGE THE MODEL  &*
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'ProductAttribute' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'ClassNum' iv_abap_fieldname = 'CLASSNUM' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 18 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'ObjectKey' iv_abap_fieldname = 'OBJECTKEY' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'ObjectTable' iv_abap_fieldname = 'OBJECTTABLE' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 30 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Characteristic' iv_abap_fieldname = 'CHARACT' ). "#EC NOTEXT
lo_property->set_is_key( ).
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 30 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'ValueChar' iv_abap_fieldname = 'VALUE_CHAR' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 30 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'CharactDescr' iv_abap_fieldname = 'CHARACT_DESCR' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 30 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        ...
        iv_value    = 'false' ).
lo_property->set_as_title( iv_keep_in_content = abap_true ).
lo_property = lo_entity_type->create_property( iv_property_name = 'ValueFrom' iv_abap_fieldname = 'VALUE_FROM' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'ValueTo' iv_abap_fieldname = 'VALUE_TO' ). "#EC NOTEXT
lo_property->set_type_edm_double( ).
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
lo_property->set_sortable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'CurrencyFrom' iv_abap_fieldname = 'CURRENCY_FROM' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 5 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'CurrencyTo' iv_abap_fieldname = 'CURRENCY_TO' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 5 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'UnitFrom' iv_abap_fieldname = 'UNIT_FROM' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 3 ). "#EC NOTEXT
lo_property->set_conversion_exit( 'CUNIT' ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'UnitTo' iv_abap_fieldname = 'UNIT_TO' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 3 ). "#EC NOTEXT
lo_property->set_conversion_exit( 'CUNIT' ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZSRA016_S_PA_PRODUCT_ATTRB'
                                iv_bind_conversions = 'X' ). "#EC NOTEXT
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'ProductAttributeCollection' ). "#EC NOTEXT
...
lo_entity_set->set_filter_required( abap_true ).
  ...
  method DEFINE_PRODUCTAVAILABILITY.
*&---------------------------------------------------------------------*
*&           Generated code for the MODEL PROVIDER BASE CLASS         &*
*&                                                                     &*
*&  !!!NEVER MODIFY THIS CLASS. IN CASE YOU WANT TO CHANGE THE MODEL  &*
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'ProductAvailability' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Customerprice' iv_abap_fieldname = 'CUSTOMERPRICE' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'CustomerGroup' iv_abap_fieldname = 'CUSTOMER_GROUP' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'RequiredDate' iv_abap_fieldname = 'REQ_DATE' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
lo_property->set_sortable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'RequiredQty' iv_abap_fieldname = 'REQ_QTY' ). "#EC NOTEXT
lo_property->set_type_edm_decimal( ).
lo_property->set_precison( iv_precision = 3 ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'EstimatedDate' iv_abap_fieldname = 'COM_DATE' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
lo_property->set_sortable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'AvailableQty' iv_abap_fieldname = 'COM_QTY' ). "#EC NOTEXT
lo_property->set_type_edm_decimal( ).
lo_property->set_precison( iv_precision = 3 ). "#EC NOTEXT
lo_property->set_maxlength( iv_max_length = 13 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'ContactNo' iv_abap_fieldname = 'CONTACT_NO' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
lo_property->set_sortable( abap_false ).
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZSRA016_S_PA_PRODUCT_AVAIL'
                                iv_bind_conversions = 'X' ). "#EC NOTEXT
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'ProductAvailabilityCollection' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Pfach' iv_abap_fieldname = 'PFACH' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 10 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZOTC_SHIPTO_VALUE_HELP'
                                iv_bind_conversions = 'X' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZSRA016_PRICE_AVAI_MPC=>TS_SOLDTO' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20190905182724'.                  "#EC NOTEXT
...
clear ls_text_element.
ls_text_element-artifact_name          = 'Shiptoparty'.                 "#EC NOTEXT
...
clear ls_text_element.
ls_text_element-artifact_name          = 'CityZip'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'Customer'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'SalesOrganization'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'Customer'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'SalesOrganizationName'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'Customer'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'DistributionChannel'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'Customer'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'DistributionChannelName'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'Customer'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'DivisionName'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'Customer'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'ProductAvailability'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'Customerprice'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'ProductAvailability'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'CustomerGroup'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'ProductAvailability'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'MyProductNo'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'Product'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'ProductReferenceNo'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'Product'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'ProductListPrice'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'Product'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'PrdSearch'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'Product'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'Pfach'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'SoldTo'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
clear ls_text_element.
ls_text_element-artifact_name          = 'ProductAttributeCollection'.                               "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'ProductAvailabilityCollection'.                               "#EC NOTEXT
ls_text_element-artifact_type          = 'ENSE'.                                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'MODL'.                                            "#EC NOTEXT
ls_text_element-text_symbol            = '018'.                            "#EC NOTEXT
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'Customers'.                               "#EC NOTEXT
ls_text_element-artifact_type          = 'ENSE'.                                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'MODL'.                                            "#EC NOTEXT
ls_text_element-text_symbol            = '019'.                            "#EC NOTEXT
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'ProductCollection'.                               "#EC NOTEXT
ls_text_element-artifact_type          = 'ENSE'.                                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'MODL'.                                            "#EC NOTEXT
