...
*----------------------------------------------------------------------*
* WRICEF ID:   D3_OTC_FDD_0013_Monthly Open AR Statement               *
*----------------------------------------------------------------------*
* DESCRIPTION: This include is copied from standard include RFKORI90   *
*              necessary modifications are made for multiple spool     *
*              generations during print to customer .                  *
...
* =========== ======== ========== =====================================*
* 25-JAN-2018 SMUKHER4    E1DK931140 Initial Development                  *
...
*&-->Begin of change for D3R3 for D3_OTC_FDD_0013 by SMUKHER4 on 25-jan-2018
*&--Code added for multiple spool generation for each customer number.
*&--This logic will be driven by check box added in the selection screen.
  IF p_chkbox IS NOT INITIAL.
  Gs_outputparams-reqnew = 'X' .
  CLEAR: fp_outputparams_last-reqnew.
  ENDIF.
*&<--End of change for D3R3 for D3_OTC_FDD_0013 by SMUKHER4 on 25-jan-2018
      ...
      If Xopen = 'Y'.                                           "1636232
        ...
        IF gd_is_open = 'X'.
          ...
          ELSE.
            ...
            exporting Ib_send = 'Y'                             "1636232
            tables Et_messages = Lt_messages.                   "1636232
...
*p_outputparams-SPONUMIV     =
  ...
  p_outputparams-noprint      = p_itcpo-tdnoprint.
   ...
   exporting Ib_bundling = 'X'                                  "1636232
   importing Ed_device   = Htddevice                            "1636232
             Eb_send     = Gb_send                              "1636232
             Eb_archive  = Gb_archive                           "1636232
   tables It_mail_recip  = Gt_mail_recip                        "1636232
          It_fax_recip   = Gt_fax_recip                         "1636232
   changing Cs_params    = P_outputparams.                      "1636232
...
*     do nothing
   When '2' or 'I'.                  "FAX or email
      ...
      exporting Id_faxnr   = Ld_faxnr
                Id_land1   = Finaa-Tdteleland
                Id_mailadr = Finaa-Intad
      tables Ct_mail_recip = Gt_mail_recip
...
Form Send_pdf using It_daratab type Tfpdara                     "1636232
   ...
   importing Es_error = Ls_message
   tables It_mail_receivers = Gt_mail_recip
