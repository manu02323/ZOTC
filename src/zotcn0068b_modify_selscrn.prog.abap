...
*&---------------------------------------------------------------------*
************************************************************************
* PROGRAM    :  ZOTCN0068B_MODIFY_SELSCRN                              *
* TITLE      :  OTC_CDD_0068B SALES ORDER OUTPUT                       *
* DEVELOPER  :  Pallavi Gupta                                          *
* OBJECT TYPE:  Include                                                *
* SAP RELEASE:  SAP ECC 6.0                                            *
*----------------------------------------------------------------------*
* WRICEF ID  :  OTC_CDD_0068B SALES ORDER OUTPUT CONVERSION            *
*----------------------------------------------------------------------*
* DESCRIPTION:  Selection Screen for Uploading Conditional Records     *
*               into SAP from the input Text File .                    *
*----------------------------------------------------------------------*
